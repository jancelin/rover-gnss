...
#define MQTT_SERVER "IP FOR MQTT_SERVER"
#define MQTT_PORT 1883
#define MQTT_OUTPUT "your mqtt/output/chanel";
#define MQTT_INPUT "your mqtt/input/chanel";
...
#define NTRIP_CASTER_MOUNTPOINT "YOUR CASTER MOUNTPOINT"
